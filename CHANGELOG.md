...
* **backend:** PTR-41 implement combat websocket room ([#53](https://github.com/enotbert/PTR_v2/issues/53)) ([5bee3c8](https://github.com/enotbert/PTR_v2/commit/5bee3c80d749599a2d6d310925077584cec34ca6))
...
* **combat:** PTR-45 WebSocket RL commands, emoji, and phrases ([#58](https://github.com/enotbert/PTR_v2/issues/58)) ([b252cb2](https://github.com/enotbert/PTR_v2/commit/b252cb20eb520c2b798f9b86778e6945645a10b3))
* **combat:** PTR-46 resolve raid outcome and reward issuing ([#60](https://github.com/enotbert/PTR_v2/issues/60)) ([d74687d](https://github.com/enotbert/PTR_v2/commit/d74687dcaedb2c31af951b5f58e844abc461c2c2))
* **combat:** PTR-47 implement idempotent reward claim ([#61](https://github.com/enotbert/PTR_v2/issues/61)) ([3d0f098](https://github.com/enotbert/PTR_v2/commit/3d0f098d7e90eb819e6bf9a4a431867b9eb93d2a))
...
* **frontend:** PTR-42 add combat canvas presentation layer ([#55](https://github.com/enotbert/PTR_v2/issues/55)) ([1261193](https://github.com/enotbert/PTR_v2/commit/12611937cf3d98a3759dcf72d1add2ba1bb504d4))
* **frontend:** PTR-43 add combat HUD skill controls ([#56](https://github.com/enotbert/PTR_v2/issues/56)) ([0cb607d](https://github.com/enotbert/PTR_v2/commit/0cb607d29132492385f54a7e330760a6e1a799b6))
* **frontend:** PTR-44 add target selection flow ([#57](https://github.com/enotbert/PTR_v2/issues/57)) ([8549022](https://github.com/enotbert/PTR_v2/commit/854902268f3d4e41f24583e17604583cfa3f1952))
* **frontend:** PTR-48 implement raid result and reward screen ([#62](https://github.com/enotbert/PTR_v2/issues/62)) ([51e836e](https://github.com/enotbert/PTR_v2/commit/51e836e239a46e104dbef834519647e04cde68ae))
* **frontend:** PTR-49 refresh tavern contribution progress ([#64](https://github.com/enotbert/PTR_v2/issues/64)) ([8b76521](https://github.com/enotbert/PTR_v2/commit/8b765216957ee55c422be664a1e7ee41a4489ec1))
