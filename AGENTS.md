...
- [ ] **Изменения сервисов из `docker-compose.yml` проверены строго через Docker Compose** (см. [`.ai/rules/40-code-quality.md`](.ai/rules/40-code-quality.md) — «Строгая проверка в Docker»)
